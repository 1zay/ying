...
const AP_Param::Info Sub::var_info[] = {
    ...
    //改动
    //GSCALAR(test,  "TEST",    BATT_VOLTAGE_LIMIT),
    GSCALAR(test1,  "TEST1",    6.0),
    ...
    //改动
    GOBJECT(my_Notify, "NTF_",  AP_my_Notify),
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    //改动
    //AP_SUBGROUPINFO(MAV_BATTERY_CHARGE_STATE, "TEST", 254, Parameters,k_param_test),
