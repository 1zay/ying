...
const AP_Scheduler::Task Sub::scheduler_tasks[] = {
    ...
    //SCHED_TASK_CLASS(my_AP_Notify,   &sub.my_notify,  update,    50,  90),
    //SCHED_TASK(update_my_led, 1, 90),
    SCHED_TASK(update_my_uarttest, 1, 90),
    //SCHED_TASK(update_my_logtest, 20, 90),
    //SCHED_TASK(update_my_mavtest, 20, 90),
    //SCHED_TASK_CLASS(update_my_telem2, &sub.my_notify, update, 50, 90),
    //gaiend
...
void Sub::one_hz_loop()
{
    ...
    //改动
    AP_my_Notify::flags.pre_arm_check = arm_check;
    AP_my_Notify::flags.pre_arm_gps_check = position_ok();
    AP_my_Notify::flags.flying = motors.armed();
