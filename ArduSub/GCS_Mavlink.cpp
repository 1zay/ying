...
void GCS_MAVLINK_Sub::handleMessage(const mavlink_message_t &msg)
{
    ...
    //改动gai
    case MAVLINK_MSG_ID_mytestmavlink: {
        mavlink_mytestmavlink_t packet;
        mavlink_msg_mytestmavlink_decode(&msg, &packet);
        hal.uartA->printf("mav succeed");
        //mavlink_msg_mytestmavlink_send(MAVLINK_COMM_0, packet.testdate, packet.love);
        break;
    }
    //gend
