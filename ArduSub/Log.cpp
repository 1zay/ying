...
// Write a mytestlog
void Sub::Log_Write_mytestlog()
{
    struct log_mytestlog pkt = {
        LOG_PACKET_HEADER_INIT(LOG_mytestlog_MSG),
        time_us         : AP_HAL::micros64(),
        heartb          : 99,
        love            : "i love ying",
        lovel           : 'l',
...
const struct LogStructure Sub::log_structure[] = {
    ...
    //gai改动
    { LOG_mytestlog_MSG, sizeof(log_mytestlog),
    "MLOG",  "QfNnnnn",    "TimeUS,heartb,love,lovel,loveo,lovev,lovee", "s------", "F2-----" },
    //gend
};
