 ...
 */
void my_ExternalLED::update(void)
{
    ...
    if (_pattern != NONE) {
        ...
        if (AP_my_Notify::flags.failsafe_battery || AP_my_Notify::flags.failsafe_radio) {
...
void my_ExternalLED::set_pattern(LEDPattern pattern_id)
{
    _pattern = pattern_id;
    _pattern_counter = 0;
}
...
void my_ExternalLED::armed_led(bool on_off)
{
...
void my_ExternalLED::gps_led(bool on_off)
{
...
void my_ExternalLED::motor_led1(bool on_off)
{
...
// motor_led - set motor light on or off
void my_ExternalLED::motor_led2(bool on_off)
{
...
#else
bool my_ExternalLED::init(void) {return true;}
void my_ExternalLED::update(void) {return;}
#endif
