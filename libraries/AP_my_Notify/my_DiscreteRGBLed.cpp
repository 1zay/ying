...
my_DiscreteRGBLed::my_DiscreteRGBLed(uint16_t red, uint16_t green, uint16_t blue, bool normal_polarity)
    : my_RGBLed(normal_polarity ? 0 : 1,
             normal_polarity ? 1 : 0,
             normal_polarity ? 1 : 0,
             normal_polarity ? 1 : 0),
      red_pin_number(red),
...
bool my_DiscreteRGBLed::hw_init(void)
{
...
bool my_DiscreteRGBLed::hw_set_rgb(uint8_t red, uint8_t green, uint8_t blue)
{
    red_pin->write(!!red);
