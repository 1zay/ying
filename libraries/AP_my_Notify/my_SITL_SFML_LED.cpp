...
my_SITL_SFML_LED::my_SITL_SFML_LED():
...
void my_SITL_SFML_LED::update_thread(void)
{
    sf::RenderWindow *w;
    {
...
void *my_SITL_SFML_LED::update_thread_start(void *obj)
{
    ((my_SITL_SFML_LED *)obj)->update_thread();
    return nullptr;
}

bool my_SITL_SFML_LED::hw_init()
{
...
bool my_SITL_SFML_LED::hw_set_rgb(uint8_t _red, uint8_t _green, uint8_t _blue)
{
    red = _red;
    green = _green;
    blue = _blue;
