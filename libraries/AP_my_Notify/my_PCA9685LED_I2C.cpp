...
my_PCA9685LED_I2C::my_PCA9685LED_I2C() : 
    my_RGBLed(NAVIO_LED_OFF, NAVIO_LED_BRIGHT, NAVIO_LED_MEDIUM, NAVIO_LED_DIM)
{
}

bool my_PCA9685LED_I2C::hw_init()
{
    ...
    _dev->register_periodic_callback(20000, FUNCTOR_BIND_MEMBER(&my_PCA9685LED_I2C::_timer, void));

    return true;
}

// set_rgb - set color as a combination of red, green and blue values
bool my_PCA9685LED_I2C::hw_set_rgb(uint8_t red, uint8_t green, uint8_t blue)
{
    rgb.r = red;
    rgb.g = green;
    rgb.b = blue;
...
void my_PCA9685LED_I2C::_timer(void)
{
    if (!_need_update) {
        return;
    }
