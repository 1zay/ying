...
my_DiscoLED::my_DiscoLED():
    my_RGBLed(DISCO_LED_OFF, DISCO_LED_HIGH, DISCO_LED_MEDIUM, DISCO_LED_LOW),
...
bool my_DiscoLED::hw_set_rgb(uint8_t red, uint8_t green, uint8_t blue)
{
    switch (backend) {
    case PWM_SYSFS:
