...
my_Led_Sysfs::my_Led_Sysfs(const char *red, const char *green, const char *blue,
                    uint8_t off_brightness, uint8_t low_brightness, uint8_t medium_brightness, uint8_t high_brightness):
    my_RGBLed(off_brightness, high_brightness, medium_brightness, low_brightness),
    red_led(red),
    green_led(green),
    blue_led(blue)
{
...
bool my_Led_Sysfs::hw_set_rgb(uint8_t red, uint8_t green, uint8_t blue)
{
