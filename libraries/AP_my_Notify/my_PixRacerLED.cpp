...
my_PixRacerLED::my_PixRacerLED() :
    my_RGBLed(0, 1, 1, 1)
{
}

bool my_PixRacerLED::hw_init(void)
{
...
bool my_PixRacerLED::hw_set_rgb(uint8_t r, uint8_t g, uint8_t b)
{
...
#else
bool my_PixRacerLED::hw_init(void) { return true; }
bool my_PixRacerLED::hw_set_rgb(uint8_t r, uint8_t g, uint8_t b) { return true; }
#endif
