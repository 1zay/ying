...
ap_message GCS_MAVLINK::mavlink_id_to_ap_message_id(const uint32_t mavlink_id) const
{
    ...
    static const struct {
        ...
        //{ MAVLINK_MSG_ID_ESC_TELEMETRY,         MSG_ESC_TELEMETRY},
        //改动gai
        { MAVLINK_MSG_ID_mytestmavlink,         MSG_MYTESTMAVLINK},
        //gend
            };
...
bool GCS_MAVLINK::try_send_message(const enum ap_message id)
{
    ...
    case MSG_AUTOPILOT_VERSION:
        ...
        break;
    //改动gai
    case MSG_MYTESTMAVLINK:
        CHECK_PAYLOAD_SIZE(mytestmavlink);
        mavlink_mytestmavlink_t mypack= 
        {
            0x01,0x01,0x01,0x01,0x01,
            'z','z','z','z','z','z','z','z','z','z','z'
        };
        mavlink_msg_mytestmavlink_send(
            chan,
            mypack.testdate,
            mypack.love
        );
